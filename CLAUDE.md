...
| developer-workflow | `plugins/developer-workflow/` | Toolbox of on-demand workflow skills — research, review, spec, QA, PR |
...
plugins/
  ...
  developer-workflow/           # On-demand workflow skills + manual-tester agent
