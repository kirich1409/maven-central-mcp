...
| explore-app | `/explore-app` | Undirected QA: поиск багов без спецификации |
...
- **mobile MCP** — для тестирования на устройстве (`acceptance`, `explore-app`)
...
| `/explore-app` | developer-workflow | Поиск багов без спецификации |
