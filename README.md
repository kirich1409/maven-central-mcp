...
**Skills (14):** `/research`, `/decompose-feature`, `/write-spec`, `/multiexpert-review`, `/implement`, `/debug`, `/write-tests`, `/generate-test-plan`, `/acceptance`, `/bug-hunt`, `/create-pr`, `/drive-to-merge`, `/feature-flow`, `/bugfix-flow`
