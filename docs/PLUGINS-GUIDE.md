...
| multiexpert-review | `/multiexpert-review` | Multi-agent ревью плана по протоколу PoLL (Panel of LLM Evaluators) |
...
| `/multiexpert-review` | developer-workflow | Multi-agent ревью плана (PoLL) |
