...
All engine errors produce the exact prefix `[multiexpert-review ERROR] <CATEGORY>: <details>` as the first line of conversation output. Consumers detect this prefix to distinguish engine errors from ordinary review FAIL verdicts. Categories:
