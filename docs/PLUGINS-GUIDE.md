...
| test-feature | `/test-feature` | Верификация фичи на живом приложении по спецификации |
| exploratory-test | `/exploratory-test` | Undirected QA: поиск багов без спецификации |
...
| address-review-feedback | `/address-review-feedback` | Обработка review-комментариев: анализ, triage, исправления, ответы |
| pr-drive-to-merge | `/pr-drive-to-merge` | Мониторинг CI/CD, обработка review, доведение PR до merge |
...
flowchart TB
    subgraph Skills
        ...
        drive[pr-drive-to-merge]
        testFeat[test-feature]
        explTest[exploratory-test]
...
flowchart LR
    ...
    drive --> feedback["/address-review-feedback"]
    feedback --> drive
    genPlan["/generate-test-plan"] --> testFeat["/test-feature"]
...
- **gh CLI** — обязательно для PR-related skills (`create-pr`, `address-review-feedback`, `pr-drive-to-merge`)
- **mobile MCP** — для тестирования на устройстве (`test-feature`, `exploratory-test`)
...
| `/test-feature` | developer-workflow | Верификация фичи на устройстве |
| `/exploratory-test` | developer-workflow | Поиск багов без спецификации |
| `/create-pr` | developer-workflow | Создание pull request |
| `/address-review-feedback` | developer-workflow | Обработка review-комментариев |
| `/pr-drive-to-merge` | developer-workflow | Доведение PR до merge |
