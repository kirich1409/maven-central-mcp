...
drop into Plan Mode to break it into tasks and execute.
```
...
picked up later in Plan Mode, producing a complete implementation with user
involvement only at genuine critical blockers.
