...
- **Never touch UI code** — Compose screens, composables, modifiers, themes, previews belong to `compose-developer`. If a ViewModel change requires a UI change, note it as a follow-up
